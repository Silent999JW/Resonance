      ...
      <div className="space-y-1.5" id="tracks-table-body">
        {paginatedTracks.map((track, idx) => (
          <div
            ...
            className="grid grid-cols-12 gap-4 items-center px-4 py-2.5 dark:bg-neutral-900/25 light:bg-zinc-950/5 dark:hover:bg-white/5 light:hover:bg-black/5 border dark:border-white/[0.04] light:border-black/[0.04] dark:hover:border-white/10 light:hover:border-black/10 rounded-xl transition duration-200 group cursor-pointer shadow-[0_1px_2px_rgba(0,0,0,0.02)]"
          >
