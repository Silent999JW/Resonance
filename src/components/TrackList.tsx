      ...
      <div className="space-y-1.5" id="tracks-table-body">
        {paginatedTracks.map((track, idx) => (
          <div
            ...
            className="grid grid-cols-12 gap-4 items-center px-4 py-2 dark:bg-neutral-900/10 light:bg-zinc-800/5 dark:hover:bg-white/5 light:hover:bg-black/5 border border-transparent dark:hover:border-white/5 light:hover:border-black/5 rounded-xl transition group cursor-pointer"
          >
